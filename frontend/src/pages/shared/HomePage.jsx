  ...
  const features = [
    {
      ...
      description: 'Comprehensive course creation, enrollment, and management system',
      color: 'blue'
    },
    {
      icon: FiUsers,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <img src="/images/sece-logo.png" alt="SECE Logo" className="h-16 w-16 object-contain" />
              <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              <h1 className="text-5xl font-bold text-gray-900 mb-6 leading-tight">
                Welcome to <span className="text-blue-600">SECE</span> Course Management System
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                A comprehensive platform for managing courses, assignments, grades, and academic activities at Sri Eshwar College of Engineering.
              </p>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                <img src="/images/sece-logo.png" alt="SECE" className="h-12 w-12" />
                <div>
                  <h3 className="font-bold text-lg">SECE</h3>
                  <p className="text-sm text-gray-400">Course Management</p>
                </div>
              </div>
              <p className="text-gray-400 text-sm">Sri Eshwar College of Engineering - Empowering education through technology</p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
            <p>&copy; 2024 Sri Eshwar College of Engineering. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
